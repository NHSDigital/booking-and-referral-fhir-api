...
def post_service_request(
        body: ServiceRequestBody, NHSD_Token: str = Header(...)
):
    return ""
...
def patch_service_request_id(id: UUID, NHSD_Token: str = Header(...)):
    return load_example("service_request/id/PATCH-success.json")


@route.put("/ServiceRequest/{id}")
def put_service_request_id(id: UUID, NHSD_Token: str = Header(...)):
    return load_example("service_request/id/PUT-success.json")


@route.delete("/ServiceRequest/{id}")
def delete_service_request_id(id: UUID, NHSD_Token: str = Header(...)):
    return ""
