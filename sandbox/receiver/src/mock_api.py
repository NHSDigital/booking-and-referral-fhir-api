...
def meta():
    ...
    return Response(response_builder(expected_response, env_name), status=expected_response,
                    mimetype='application/json')


def response_builder(http_code_response, env_name):
    if http_code_response == '200':
        return '{ "providerName": "%s", "resourceType": "CapabilityStatement", "meta": { "profile": [ ' \
